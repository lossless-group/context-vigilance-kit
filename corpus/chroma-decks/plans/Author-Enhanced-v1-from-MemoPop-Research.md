...
lede: Plan of record for diverging Enhanced-v1 from Proto by ingesting the MemoPop-generated
  investment memo (corpus/memos/memopop-generated/ChromaDB-v0.0.7/), reconciling the
  discrepancies between the founder's deck and Alpha Partners' verified research,
  and authoring concrete slide-by-slide enhancements that ground every claim in citable
  market data.
