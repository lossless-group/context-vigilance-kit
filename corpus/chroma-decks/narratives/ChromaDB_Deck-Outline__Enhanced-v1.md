...
lede: The first enhanced variant of Chroma's Series A pitch — diverging from Proto
  by integrating founder call notes (2026-04-29), live-checked primary sources (2026-05-12),
  and a tightly-screened layer of analyst-cited category framing. Adds three substantive
  new slides (Market, Backed by, Capital Efficiency) plus a reframed Use of Funds;
  locks in the funding picture, the syndicate, the enterprise ASP, and the Q4 2026
  revenue milestone. Authored as one coherent through-line so design improvisation
  can reason about the deck holistically. Management (Jeff Huber) screens before send.
