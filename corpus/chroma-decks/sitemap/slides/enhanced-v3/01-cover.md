...
lede: First seed per-slide component authored under Phase A+.4. Faithful recreation
  of the cover section from the scroll variant — same headline, eyebrow, v3-cover
  class. Proves that the Play-UI runtime can render a real slot identical to its Scroll-UI
  counterpart. Self-contained styles + imports `../../../styles/global.css` so v3-*
  tokens resolve in standalone play context.
...
- Shipped
- Phase-A-Plus-Seed
site_uuid: aeecffe1-9665-4fac-acf9-0db8e018f7ce
hex_code: svra7k
date_authored_current_draft: 2026-05-12
publish: true
source_root: /Users/mpstaton/code/lossless-monorepo/ai-labs/dididecks-ai/client-sites/chroma-decks/context-v
source_relative_path: sitemap/slides/enhanced-v3/01-cover.md
source_repo_slug: chroma-decks
collated_at: '2026-08-18'
source_path: "ai-labs/dididecks-ai/client-sites/chroma-decks/context-v/sitemap/slides/enhanced-v3/01-cover.md"
---
