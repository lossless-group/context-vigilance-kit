...
lede: Side-by-side reconciliation of every fact-bearing claim where the founder's
  Series A deck (2026-05-11), the founder call notes (2026-04-29), live primary sources
  (2026-05-12), and the MemoPop-generated investment memo (ChromaDB v0.0.7, 2026-05-03)
  intersect or disagree. The call notes substantially close the open questions from
  v0.0.1.0; what remains is the disclosure-level decision on the Ask slide and a small
  handful of memo-only-but-keepable category-framing claims.
