...
image_prompt: A top-down angle of a desk, with a magazine spread open in front of
  a window. The magazine has a clean, modern design with a focus on typography and
  whitespace. To the left of the magazine is a computer monitor, with a news site
  open. The desk is cluttered with papers and a coffee cup.
