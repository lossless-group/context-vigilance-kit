...
lede: How to configure the `tree` command to display hidden directories and files
  when visualizing project folder structures.
...
image_prompt: Terminal window showing a tree command output with hidden directories
  and files, modern developer workspace, clean visualization.
...
source_relative_path: issue-resolution/Showing Hidden Directories in Tree Output.md
source_repo_slug: lost-in-public
collated_at: '2026-08-18'
source_path: "content/lost-in-public/issue-resolution/Showing Hidden Directories in Tree Output.md"
---
