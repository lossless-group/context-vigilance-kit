...
lede: Analyze and extract design patterns and UI components from external websites
  for inspiration
...
image_prompt: A UI inspiration dashboard that pulls visual ideas from various URLs,
  displaying a mosaic of website screenshots, color palettes, and design notes. The
  interface is creative, exploratory, and visually rich.
...
source_relative_path: prompts/user-interface/Get-UI-Inspiration-From-URL.md
source_repo_slug: lost-in-public
collated_at: '2026-05-08'
source_path: "content/lost-in-public/prompts/user-interface/Get-UI-Inspiration-From-URL.md"
---
