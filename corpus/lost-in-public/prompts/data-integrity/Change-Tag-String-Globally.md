...
image_prompt: A digital dashboard or code editor interface showing a global search
  and replace operation, with highlighted tag strings being updated across multiple
  files. The scene conveys automation, precision, and data integrity, with visual
  cues like checkmarks, code snippets, and a unified UI palette.
...
source_relative_path: prompts/data-integrity/Change-Tag-String-Globally.md
source_repo_slug: lost-in-public
collated_at: '2026-05-08'
source_path: "content/lost-in-public/prompts/data-integrity/Change-Tag-String-Globally.md"
---
