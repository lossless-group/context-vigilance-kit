...
eyebrow: null
headline: Momentum
subhead: 'Consumer adoption is accelerating — what was niche has become mainstream:
  The ecosystem is maturing with real capital and exits.

  '
consumer_stats:
- value: 58%
  body: of EU adults used a health or fitness **wearable** at least once per week
    in 2024.
  icon_hint: smartwatch
- value: $140B
  body: in sales are expected for the vitamins and **supplements** market in 2025.
  icon_hint: supplement-bottle
- value: 10M
  body: of Americans were on **GLP-1** weight loss treatments in 2025, up from 6M
    in 2024.
  icon_hint: glp1-pen
exit_timeline:
- phase: pre-Covid
...
- phase: Future
  label: unicorns?
exit_examples:
- headline: WHOOP Crosses Into Decacorn Territory With $575M Series G
  detail: 'Valued at $10.1 billion — nearly triple its 2021 valuation — backed by
    Abbott, Marc Cuban, Cristiano Ronaldo, LeBron James, and several months funds
    from Qatar and UAE.

    '
  date: March 31, 2026
  category: Breaking
- headline: Function Health Valued at $2.5 Billion After $298M Series B
  company_value: $2.5B
  raise_amount: $298M
  category: Consumer Health
- headline: Kaia Health acquired by Sword Health for $285M — Europe's digital health
    exits are here
  detail: 'Munich-founded digital therapy startup sold to US-based Sword Health, giving
    the acquirer a foothold in Germany''s reimbursement system covering 70M+ insured
    patients.

    '
  deal_value: $285M
  follow_on_metric: 70M+
  follow_on_label: Insured Germans covered via D&A pathway
  category: European Exit
key_stat: null
key_stat_label: null
cta_or_footer: 'The funding rounds show the world is paying attention and the acquisitions
  show the exits are real. The size of those exits, $200–500M (M&A-driven and strategic
  buyers) showcase what kind of fund you need to be to win here at the moment in time.
  Not a giant but a small specialist, by design.
