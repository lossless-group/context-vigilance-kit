---
slide_number: 13
slug: community-portfolio-service
section: Edge
eyebrow: null
headline: Community driven approach
subhead: 'Despite our lean team, we leverage a strong network of investors, Supporting
  Partners and peers to deliver meaningful value to our founders.

  '
testimonials:
- quote: 'Calm/Storm''s community has been an absolute rock, supporting us through
    thick and thin.

    '
  name: Frank Westermann
  company: 9am Health
  note: former CEO mySugr
- quote: 'They are a practical no-nonsense investor, who backed us from day one.

    '
  name: Eirini Rapti
  company: Inne
- quote: 'As we''ve scaled beyond Series B, Calm/Storm''s community has been invaluable.
...
program_summary:
  always_on:
  - bold: All year round
    body: we cultivate a strong community of like-minded entrepreneurs, industry experts
      and investors.
  - bold: Hands-on early support
    body: across fundraising, go-to-market, customer development, hiring, and key
      introductions.
  programs:
  - bold: Founder Academies (online)
    body: with deep dives into fundraising, team building, PR and more.
  - bold: In-person Founder Meetups
    body: across major European hubs (London, Berlin, Nordics) to foster meaningful
      connections.
key_stat: null
key_stat_label: null
cta_or_footer: 'We actively connect our community, ensuring our founders benefit from
  consistent, high-quality support. We have the largest synergetic founder health
  community in Europe and we leverage it.
...
source_path: "astro-knots/sites/calmstorm-decks/context-v/narratives/13-community-portfolio-service.md"
---

# Slide 13 — Community-driven approach
...
1. Headline + subhead
2. **Three testimonials** — quotes + names + company + the *former CEO mySugr* annotation visible
3. Two program clusters on the right — *always-on* and *programs* (Academies / Meetups)
4. **Footer-statement — pulled out as a closing claim**, visually distinct (maybe bordered, italic, or in a band)
5. Optional: portfolio-event photography or, in lieu, a counter ("X events in 2024", "Y founders attended").
