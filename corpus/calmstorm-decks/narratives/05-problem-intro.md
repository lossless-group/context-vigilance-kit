...
eyebrow: null
headline: Problem
subhead: 'European healthcare is reaching a breaking point: Demand is surging, supply
  is collapsing, outcomes are deteriorating.

  '
columns:
- number: '1'
  title: Demand is exploding
  points:
  - bold: Demographic pressure
    body: 2.1B people aged 60+ by 2050 (which is approx. double compared to today).
  - bold: Cost explosion
    body: Health spend accounted for +10% of EU GDP in 2023.
  - bold: Leading cause of death
    body: 35% of people live with a chronic condition in Europe as of 2025.
- number: '2'
  title: Supply is breaking
  points:
  - bold: Labour shortage
    body: 4M clinical worker shortage expected in Europe by 2030.
  - bold: Administrative burden
    body: 55% of HCPs' time is spent in administrative tasks.
  - bold: Waiting times for diagnosis
    body: 200K avoidable cancer deaths per year in Europe due to delays in diagnosis.
- number: '3'
  title: Outcomes are getting worse
  points:
  - bold: Women's health crisis
    body: Maternal deaths rose 85% from 2017–2021.
  - bold: Mental health conditions
    body: 1 in 6 people live with a mental health condition in Europe.
  - bold: Inaccurate diagnoses
    body: 15% of diagnoses are wrong — a direct risk to patients and a hidden cost
      to the system.
key_stat: €1,720B
key_stat_label: European healthcare industry size
cta_or_footer: 'In Europe alone Healthcare is a EUR 1,720 billion industry and yet
  one of the least digitized sectors in the economy. Demand is outpacing supply. Technology
  isn''t optional anymore, it must close the gap.
...
source_path: "astro-knots/sites/calmstorm-decks/context-v/narratives/05-problem-intro.md"
---
