---
slide_number: 14
slug: success-in-numbers
section: Receipts
eyebrow: null
headline: Numbers
subhead: From niche player to industry leader — 6 years of execution.
stats_grid:
- value: €>50M
  label: AuM
- value: 60+
  label: Active HealthTech Portcos
- value: 120+ / 18
  label: Portfolio Founders / Countries
- value: '>1,500'
  label: FTEs (total portfolio)
- value: '>80%'
  label: Port.Cos raised Follow-on Funds
- value: 15 Series A & 4 Series B
  label: Port.Cos raised from Tier 1 VCs
- value: €>515M
  label: Cumulated Follow-on Funding
- value: €>3B
  label: Combined Enterprise Value
- value: 1,000+
  label: Co-Investors (VCs & BA / FO)
- value: 111+
  label: Calm/Storm Investors (LPs)
- value: 60+
  label: Supporting Partners (SPs)
- value: 100+
  label: Co-Investments from / with LPs
key_stat: €>3B
key_stat_label: Combined Enterprise Value
cta_or_footer: 'Calm/Storm: the largest group of HealthTech entrepreneurs, investors
...
source_path: "astro-knots/sites/calmstorm-decks/context-v/narratives/14-success-in-numbers.md"
---
...
5. **Footer-claim** — *the largest group of HealthTech entrepreneurs / investors / experts in Europe* — visible, italic or bordered
