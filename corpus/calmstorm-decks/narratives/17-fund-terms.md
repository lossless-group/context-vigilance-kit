...
section: Fund
eyebrow: null
headline: Our proposed Terms
subhead: Fund III Factsheet
terms:
- label: Domicile
  value: 'Proposal: Austria / EuVECA fund'
- label: Management Company
  value: Calm Storm Management GmbH (AIFM Austria)
- label: Management & Ownership
  value: Lucanus, Stephanie, Johannes, Ekaterina
- label: Vertical Focus
  value: HealthTech startups in Pre-Seed and Seed stage
- label: Geographic Focus
  value: Europe
- label: Size
  value: Target € 50m
- label: Duration
  value: 10 years (2 year extension), 4–5 years investment period
- label: Management Fee
  value: 2.0 % p.a. average (frontloading)
- label: Hurdle & Carry
  value: 1.3× Hurdle & 20%
- label: Legal Support
  value: Schoenherr Attorneys at Law
- label: Fund Admin
  value: Argon Tax Advisors
key_stat: €50M
key_stat_label: target fund size
cta_or_footer: null
sources: []
site_uuid: 20a10676-d990-4444-8b50-d7c5c08196ba
hex_code: l6wlom
