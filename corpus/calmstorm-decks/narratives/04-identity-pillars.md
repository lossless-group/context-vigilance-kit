...
- number: '01'
  title: Europe's
  body: Sifted ranked us
  stat:
    value: 60+
    label: The largest European HealthTech portfolio
- number: '02'
  title: Industry Focus
  body: Health is hard — only a specialist can win. Focusing exclusively on one industry,
    we ensure better access, sharper judgment, and stronger outcomes.
  stat:
    value: '>10k'
    label: HealthTech deals received since 2020
- number: '03'
  title: Community Approach
  body: We are a community of founders. More than 200 portfolio founders and Supporting
    Partners create a flywheel for venture — founder-to-founder support.
  stat:
    value: 50+
    label: Founder events hosted over the last 5 years
- number: '04'
  title: Proprietary Deal Access
  body: Deep integration within the European ecosystem ensures we see more deals than
    any other HealthTech fund on the market.
  stat:
    value: '>80%'
    label: European early-stage health-deal visibility
- number: '05'
  title: Early-Stage & Discipline
  body: We invest early, where conviction matters most. A small fund by design — focused
    on access, ownership, and disciplined portfolio construction.
  stat:
    value: €50M
    label: Target size of Fund III; fits the stage & industry
key_stat: null
key_stat_label: null
cta_or_footer: null
sources: []
...
1. Brand mark "Calm/Storm" + eyebrow "Who are we"
2. Five stats (large, equal weight) — the proof
3. Five pillar titles (small caps or short headings)
4. Pillar bodies (compact paragraphs)
5. Pillar numbers (decorative, large or watermark)
