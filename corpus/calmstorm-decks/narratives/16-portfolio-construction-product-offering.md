---
slide_number: 16
slug: portfolio-construction-product-offering
section: Fund
eyebrow: null
headline: Our Offering
subhead: Fund III — establishing ourselves as a European lead investor in HealthTech.
commitments:
- icon_hint: seed-being-planted
  title: 30 category defining HealthTech startups
  body: 'We will invest in **30 category defining HealthTech startups**. The largest
    share of our initial investment volume allocation goes to Pre-Seed lead tickets
    rounds.

    '
- icon_hint: seedling
  title: Seed investments + follow-on
  body: 'We will also make new **Seed investments** and follow on in ~ 50% of our
    Pre-Seed companies, often increasing our ownership.

    '
- icon_hint: cupped-hand-sapling
  title: Follow-on capital allocation
  body: 'Up to **1/3** of our total investment volume is allocated to **follow-on
    capital** focusing on pro-rata in **Series A** rounds.
...
construction_table:
  ...
  - label: Ticket
    ...
    - € 1–2M
    - € 0.5–1M
  - label: Init. Ownership
    values:
    - 10–12%
    - 6–10%
    - —
  - label: Init. Invest Volume
    values:
    - 60%
    - 40%
    - —
  - label: Strategy
    ...
    - Co-Lead & Follow-Ons
    - Selective Pro-Rata
return_thesis_question: How will we return the fund?
return_thesis_lines:
- Secondaries from Series C onwards (no IPOs needed for Fund Model).
- M&A to Pharma / Medtech / Insurances / US-Tech (startups & multinationals).
- Leveraging increasing maturity of European HealthTech with growing late-stage capital
  and buyer activity.
key_stat: '30'
