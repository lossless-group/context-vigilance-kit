---
slide_number: 6
slug: opportunity-intro
section: Market
eyebrow: null
headline: Opportunity
subhead: 'The same forces breaking the system are opening the market: The trends reshaping
  healthcare are the same ones we invested ahead of.

  '
columns:
- number: '1'
  title: Demand is ready to change
  points:
  - bold: Longevity goes mainstream
    body: Consumers will proactively manage health before illness through apps and
      wearables.
  - bold: Willingness to spend surges
    body: European consumers are embracing out-of-pocket prevention; insurers will
      follow.
  - bold: Underserved will be addressed
    body: D2C models will make previously ignored conditions accessible at scale.
  portfolio_examples:
  - HOLO
  - 9amHealth
- number: '2'
  title: Supply can be more efficient
  points:
  - bold: Agentic AI will run the back office
    body: Scheduling, billing, and documentation will be fully automated, giving clinicians
      time back.
  - bold: Verticalized AI will augment diagnosis
    body: Domain-specific AI models will outperform and assist physicians across specialties.
  - bold: Talent is moving towards health
    body: Founders who built Europe's previous generations of tech are now turning
      to health.
  portfolio_examples:
  - Apylon
  - Nelly
- number: '3'
  title: Outcomes will get better
  points:
  - bold: Care extends beyond the hospital
    body: Continuous monitoring replaces episodic treatment.
  - bold: Data-driven decisions reduce errors
    body: Care moves from subjective judgment to evidence-based precision.
  - bold: Incentives shift from volume to outcomes
    body: Reimbursement models evolve from fee-for-service to value-based care (outcome-focused).
  portfolio_examples:
  - visible
  - oska
key_stat: null
key_stat_label: null
cta_or_footer: 'GenAI unlocks healthcare''s complexity for the first time. This is
  the leapfrogging moment the industry has been waiting for.
...
source_path: "astro-knots/sites/calmstorm-decks/context-v/narratives/06-opportunity-intro.md"
---
...
2. Subhead — *same forces, opening the market*
3. Three column headers (parallel to slide 5)
4. Bolded trend names within each column
5. Bodies (small)
6. **Portfolio logo strips per column — visible, branded**
7. "GenAI / leapfrogging" closing line (visible)
8. Source citations (smallest, footer)
