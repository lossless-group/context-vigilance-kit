---
slide_number: 11
slug: investment-team-LPAC
section: Team
eyebrow: null
headline: Investment Team & LPAC
subhead: 'We are supported by expertise and experience in both: Health and VC.
...
advisors:
- name: Philip Jungen
  role: Entrepreneur, LP & Board of German Red Cross Pension Fund
  initials: PJ
  affiliations:
  - Kauffman Fellows
- name: Regina Hodits
  role: MD Angelini FO, Former GP Wellington Health VC
  initials: RH
  affiliations:
  - Wellington Partners
  - Angelini Ventures
- name: Lisa Pallweber
  role: Managing Partner Hans(wo)men Group, Former VC
  initials: LP
  affiliations:
  - Speedinvest
  - UNIQA Ventures
...
cta_or_footer: null
captions:
  team_caption: 'Combining deep expertise in both health and venture, our team leverages
    AI-driven technology to execute deals with speed and precision.

    '
  advisors_caption: 'We established an open feedback culture, receiving strategic
    guidance and engage in forward-looking discussions far beyond regulatory duties.
...
source_path: "astro-knots/sites/calmstorm-decks/context-v/narratives/11-investment-team-LPAC.md"
---
