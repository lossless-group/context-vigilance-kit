...
section: Team
eyebrow: null
headline: HealthTech track record
subhead: 'We are NOT building just another fund chasing a trend. We started working
  and investing in healthcare 1.5 decades ago.

  '
partner_histories:
- name: Lucanus Polagnoli
  initials: LP
  history: 'In **2012** Lucanus joins "Hansmengroup" supporting Hansi''s portfolio.
    In **2014** he joined Speedinvest as a partner building the healthtech portfolio
    — long before he started Calm/Storm. Among his HealthTech investments: **Playbrush**
    (Exit Sunstar), **Diagnosia** (Exit Apoverlag), **Juno** (Exit Flowerkid).

    '
- name: Ekaterina Gianelli
  initials: EG
  history: 'In **2014** Ekaterina joins **Inventure**, investing in software and digital
    health including **Noona** (Exit Varian). After meeting Lucanus through various
    deals and the Kauffman Fellowship, she joined Calm/Storm in 2023 as a **Venture
    Partner and member of the IC for Fund II**.

    '
- name: Stephanie Urbanski
  initials: SU
  history: 'In **2016** Stephanie joins **Playbrush** (HealthTech Startup) when Lucanus
    / Speedinvest invested. She first became a Calm/Storm Venture Partner in 2021.
    After her vesting period ended at Sunstar, Stephanie joined Calm/Storm as a **Managing
    Director and member of the IC**.

    '
- name: Johannes Blaschke
  initials: JB
  history: 'After Johannes worked at **Speedinvest**, he joined **Oxford Science Enterprises**,
    a $1.5bn+ fund in 2021. After consulting HealthTech funds and insurances at **BCG**,
    he joined Calm/Storm in 2022 later becoming a **member of the IC and Partner in
    Fund II**.

    '
firm_timeline:
- year: 2011
  event: 'Dr. Hansmann''s "Hansmengroup" starts investing in software for the health
    industry (10+ HealthTech companies): **mySugr** (Exit Roche), **Runtastic** (Exit
    Adidas), **Diagnosia** (Exit Apoverlag), **Playbrush** (Exit Sunstar), **Kiweno**
    (Exit Immundiagn).

    '
- year: 2014
  event: 'Paul Varga co-founded **Playbrush** building a connected device (dental
    care). It became one of the most prominent HealthTech companies from Austria.
    After the Exit to multinational corporation Sunstar, Paul became **Venture Partner
    of Calm/Storm in 2021**.

    '
- year: 2020
  event: '**Fund I** — 48 HealthTech Investments.

    '
- year: 2023
  event: '**Fund II** — 30+ HealthTech Investments.

    '
- year: 2026/27
  event: '**Fund III** — First Closing.

    '
key_stat: 100+
key_stat_label: Health Investments
cta_or_footer: null
sources: []
site_uuid: 180e5332-1c32-4ee5-a886-9d36926c9961
hex_code: 00jeu3
date_created: 2026-05-01
publish: true
source_root: /Users/mpstaton/code/lossless-monorepo/ai-labs/dididecks-ai/client-sites/calmstorm-decks/context-v
source_relative_path: narratives/10-track-record.md
source_repo_slug: calmstorm-decks
collated_at: '2026-08-18'
source_path: "ai-labs/dididecks-ai/client-sites/calmstorm-decks/context-v/narratives/10-track-record.md"
---
