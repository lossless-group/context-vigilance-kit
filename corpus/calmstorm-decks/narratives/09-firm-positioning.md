---
slide_number: 9
slug: firm-positioning
section: Story
eyebrow: null
headline: Calm/Storm's position in the market
subhead: We're building the most prominent brand in our sector.
columns:
- title: Industry-leading brand
  body: Recognition in the most relevant publications for the startup ecosystem.
  publications:
  - TechCrunch
  - Sifted
  - Handelsblatt
  - manager-magazin
  headline_clippings:
  - headline: Europe's most active early-stage healthtech investors
    source_outlet: Sifted
    body: Here are the investors signing the most cheques in European healthtech in
      2023, according to Dealroom data.
  - headline: Top 20 European Seed Investors
    source_outlet: Handelsblatt Digital Health
  - headline: Exclusive — Europe's most active healthtech VC Calm/Storm closes €30m
      fund
    source_outlet: Sifted
    body: 'Capital meets care: 10 venture capital firms transforming healthcare across
      Europe.

      '
- title: Co-investing with prominent Angels
  body: null
  angels:
  - name: Matt Robinson
    company: GoCardless
  ...
  - name: Philipp Moehring
    company: tiny.vc, AngelList
  - name: Taavet Hinrikus
    company: Plural, Wise
  - name: Nils Glagau
    company: Orthomol
  - name: Nico Rosberg
    company: ex Formula 1 Driver
  - name: Luca Ascani
  ...
  - name: Petter Made
    company: SumUp
- title: Tier 1 VCs love to invest in our founders
  body: null
  funds:
  - Balderton
  - Cathay Innovation
...
source_path: "astro-knots/sites/calmstorm-decks/context-v/narratives/09-firm-positioning.md"
---
