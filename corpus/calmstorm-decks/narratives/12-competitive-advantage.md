...
subhead: 'Supporting Partners: Our ''extended team'' allowing us to see, pick, win
  and support the best HealthTech deals in Europe.

  '
featured_supporting_partners:
- name: Dr. Sievert Weiss
  company: Amboss
  role: Co-Founder
- name: Nora Blum
  company: Selfapy
...
- name: Joe Spector
  company: HIMS
  role: Co-Founder
supporting_partners_grid_count: 40
supporting_partners_total: 60+
supporting_partners_label: experienced founders support Calm/Storm
capabilities:
- title: Sourcing — seeing all the deals
  body: 'Experienced founders embedded in local ecosystems, giving us early access
    to top deals, often before they reach investors.

    '
- title: Selecting — picking the best deal
  body: 'Supporting Partners are involved in the evaluation of our investment opportunities
    (incl. selective IC participation), ensuring we pick the best teams.

    '
- title: Securing — winning against others
  body: 'We do not compete with our "fund size" or "offered services". The best founders
    work with us, because of our outstanding community.

    '
- title: Servicing — supporting a large portfolio
  body: 'The philosophy is simple: Founders learn best from other founders — our SPs
    provide hands-on mentoring, experience, & support to navigate challenges.
...
cta_or_footer: null
sources: []
site_uuid: 01980c8f-04e8-4a92-b005-cf9db57fcdd5
hex_code: m4ixme
