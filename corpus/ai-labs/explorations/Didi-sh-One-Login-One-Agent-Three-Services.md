...
lede: 'We bought didi.sh. The three organically-built VC-services tools — memos (memopop-ai),
  decks (dididecks-ai), and augment-it — become one product family: independent services
  coordinated by exactly two shared planes, a common identity service and a common
  agent named didi that loads skills per task.'
