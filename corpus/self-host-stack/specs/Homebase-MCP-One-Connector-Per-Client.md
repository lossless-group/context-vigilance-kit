...
lede: A client adds one address to Claude and their agent can move across CRM, wiki,
  data room, and post planner in a single task — because one small service per client
  fronts them all, holds the credentials, and serves our skills as prompts.
